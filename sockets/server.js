...
app.post('/upload-file', (req, res) => {
  ...
  });	//al finarlizar el guardado, busca la manera de enviar el request al apartado io. para hacern un emit que le envie la imagen al cliente y asi lo envie sin problemas, tratas en la imagen en el front, no aqui.
  form.on('end', () => {
